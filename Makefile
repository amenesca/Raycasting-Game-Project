...
#    Updated: 2023/06/24 16:54:11 by femarque         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS		= ./sources/main.c ./sources/treat_initial_errors/treat_args_errors.c ./sources/utils/error.c ./sources/utils/utils.c ./sources/utils/utils2.c  tests_purpose_functions.c\
 ...
 ./sources/init_mlx/init_mlx.c ./sources/raycasting/get_info.c ./sources/raycasting/raycaster.c ./sources/free_functions/free_basic.c\
 ./sources/read_get_validate/test_colors_aux.c
