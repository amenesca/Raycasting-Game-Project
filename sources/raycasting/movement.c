...
/*   Updated: 2023/07/05 13:22:08 by femarque         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	movement_y(t_data *data)
{
	...
	(data->ray.dir[0] * data->ray.moveSpeed);
	nextpos_y = data->ray.playerpos[1] + data->ray.move_v * \
	(data->ray.dir[1] * data->ray.moveSpeed);
...
void	movement_x(t_data *data)
{
	...
	(data->ray.plane[0] * data->ray.moveSpeed);
	nextpos_y = data->ray.playerpos[1] + data->ray.move_h * \
	(data->ray.plane[1] * data->ray.moveSpeed);
	if (data->map.map[(int)nextpos_x][(int)data->ray.playerpos[1]] != '1')
		data->ray.playerpos[0] = nextpos_x;
	if (data->map.map[(int)data->ray.playerpos[0]][(int)nextpos_y] != '1')
		data->ray.playerpos[1] = nextpos_y;
...
void	mov_camera(t_data *data)
{
	...
	data->ray.dir[0] = data->ray.dir[0] * cos(data->ray.rotSpeed) - \
	data->ray.dir[1] * sin(data->ray.rotSpeed);
	data->ray.dir[1] = data->ray.old_dir_x * sin(data->ray.rotSpeed) + \
	data->ray.dir[1] * cos(data->ray.rotSpeed);
	data->ray.old_plane_x = data->ray.plane[0];
	data->ray.plane[0] = data->ray.plane[0] * cos(data->ray.rotSpeed) - \
	data->ray.plane[1] * sin(data->ray.rotSpeed);
	data->ray.plane[1] = data->ray.old_plane_x * sin(data->ray.rotSpeed) + \
	data->ray.plane[1] * cos(data->ray.rotSpeed);
}
